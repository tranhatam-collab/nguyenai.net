...
const vi: Record<RouteKey, PageContent> = {
  home: {
    ...
    superAppsSpecialized: {
      ...
      cards: [
        ...
        { name: 'Nguyen Memory', description: 'Di Sản — ảnh, tài liệu, nhật ký, oral history, archive.', tag: 'Di sản' },
        { name: 'Nguyen Knowledge', description: 'Tri Thức — lịch sử, văn hóa, thư viện, Q&A có nguồn.', tag: 'Tri thức' },
        { name: 'Nguyen Trust', description: 'Minh Chứng — claim, source, evidence, verification, audit.', tag: 'Minh chứng' },
    ...
    workflowSteps: {
      ...
      steps: [
        ...
        'Evidence Engine lưu biên nhận, nhật ký kiểm tra',
    ...
    pricingTable: {
      ...
      plans: [
        ...
        { name: 'Nguyen Family', code: 'nguyen-family', price: '599.000₫', period: '/tháng', target: 'Gia đình 2-6 người', features: ['5 Tác nhân (+Family Steward)', '20GB bộ nhớ, 50GB kho dữ liệu', '300 commands/ngày', '+ Nguyen Roots, Memory'], cta: 'Chọn Family' },
  ...
  'ai-computer': {
    ...
    sections: [
      { title: 'Khả năng vận hành', body: 'Máy có thể tiếp nhận lệnh tiếng Việt, tự lập kế hoạch, chọn mô hình, phân việc cho Tác nhân, gọi công cụ, thực hiện quy trình dài hạn, lưu bộ nhớ, xin phê duyệt, kiểm tra kết quả và phục hồi khi lỗi.' },
      { title: 'Không chia sẻ', body: 'Mỗi người dùng sở hữu một máy riêng trên đám mây, không chia sẻ bộ nhớ hay dữ liệu với người khác. Dữ liệu nằm trong ranh giới bảo mật của người dùng.' }
    ],
    featureGrid: {
  ...
  'how-it-works': {
    key: 'how-it-works', title: 'Cách vận hành — Máy Tính AI Nguyễn', description: 'Luồng vận hành: lệnh người dùng, Command Kernel, Planner, Model Router, Tool Execution, Reviewer, Evidence, Human Approval.', eyebrow: 'Cách vận hành', heroTitle: 'Từ lệnh đến kết quả có chứng cứ.', heroText: 'Người dùng ra lệnh, hệ thống lập kế hoạch, chọn mô hình, phân việc cho Tác nhân, gọi công cụ, kiểm tra kết quả, lưu bằng chứng và xin phê duyệt trước hành động nhạy cảm.', sections: [
      { title: 'Luồng vận hành', body: 'Command Kernel → Planner → Model Router → Tool Execution → Reviewer + Evidence → Human Approval.', items: ['Người dùng ra lệnh', 'Command Kernel tiếp nhận', 'Planner lập kế hoạch', 'Model Router chọn mô hình', 'Tool Execution thực thi', 'Reviewer kiểm tra', 'Evidence lưu chứng cứ', 'Human Approval phê duyệt'] }
    ]
  },
  agents: {
    ...
    featureGrid: {
      title: '9 Tác nhân chuyên biệt',
      cards: [
        { name: 'Nguyen Guide', description: 'Điều phối chính — tiếp nhận lệnh, lập kế hoạch, phân việc, tổng hợp kết quả.', tag: 'Lõi' },
  ...
  'super-apps': {
    key: 'super-apps', title: 'Siêu Ứng Dụng — Máy Tính AI Nguyễn', description: '7 Siêu Ứng Dụng đặc thù Nguyễn + 12 họ công cụ AI. Gia phả, di sản, tri thức, minh chứng, kết nối, sáng lập, chi họ — cùng văn phòng, nghiên cứu, sáng tạo, code, kinh doanh.', eyebrow: 'Siêu Ứng Dụng', heroTitle: '7 Siêu Ứng Dụng di sản + 12 họ công cụ AI.', heroText: 'Gia phả và di sản là các Siêu Ứng Dụng quan trọng, nhưng toàn bộ sản phẩm còn bao gồm làm việc, nghiên cứu, sáng tạo, kinh doanh và tự động hóa.',
    sections: [
      { title: 'Không chỉ gia phả', body: 'Máy Tính AI Nguyễn có 7 Siêu Ứng Dụng đặc thù Nguyễn cho di sản và cộng đồng, плюс 12 họ công cụ AI cho công việc hàng ngày.' }
    ],
    featureGrid: {
      title: '7 Siêu Ứng Dụng Nguyễn',
      body: 'Mỗi Siêu Ứng Dụng phục vụ một không gian sử dụng rõ ràng trong hệ sinh thái Nguyễn.',
      cards: [
        { name: 'Nguyen Roots', description: 'Cội Nguồn — family graph, cây gia phả, chi họ, quan hệ,地名, timeline.', tag: 'Di sản' },
    ...
    comparisonTable: {
      title: '12 Họ công cụ AI',
      body: 'Bên cạnh Siêu Ứng Dụng, máy có đầy đủ công cụ AI cho công việc hàng ngày.',
      columns: [{ label: 'Công cụ' }, { label: 'Chức năng' }, { label: 'Có trong gói' }],
      rows: [
    ...
    faq: [
      { question: 'Siêu Ứng Dụng khác gì với họ công cụ?', answer: 'Siêu Ứng Dụng là ứng dụng đặc thù cho hệ sinh thái Nguyễn (di sản, cộng đồng). Họ công cụ là công cụ AI chung cho công việc (văn phòng, nghiên cứu, code).' },
  ...
  models: {
    key: 'models', title: 'Mạng Mô Hình Trí Tuệ — Máy Tính AI Nguyễn', description: 'Mạng Mô Hình Trí Tuệ đa mô hình: reasoning, research, coding, translation, vision, voice, verification — không khóa vào một mô hình.', eyebrow: 'Mạng Mô Hình Trí Tuệ', heroTitle: 'Đa mô hình, không khóa vào một nhà cung cấp.', heroText: 'Máy chọn mô hình theo reasoning, research, coding, translation, vision, voice, verification, tốc độ, chi phí, quyền riêng tư và trạng thái nhà cung cấp.', sections: [
      { title: 'Tiêu chí chọn mô hình', body: 'Model Router chọn mô hình theo nhiệm vụ và ràng buộc.', items: ['Reasoning', 'Research', 'Coding', 'Translation', 'Document extraction', 'Image understanding', 'Voice', 'Verification', 'Speed', 'Cost', 'Privacy', 'Provider status'] }
    ]
  },
  'command-packs': {
    key: 'command-packs', title: 'Command Packs — Máy Tính AI Nguyễn', description: 'Các Command Pack: Family Archive, Founder Launch, Investor Readiness, Business Operations, Global Community, Bilingual Publishing, Research & Evidence, Chapter Governance, Legacy Interview, SME Automation.', eyebrow: 'Command Packs', heroTitle: 'Gói lệnh sẵn sàng cho từng nhu cầu.', heroText: 'Command Pack là tập hợp quy trình, Tác nhân và công cụ được đóng gói cho từng trường hợp sử dụng cụ thể.', sections: [
  ...
  plans: {
    key: 'plans', title: 'Gói dịch vụ — Máy Tính AI Nguyễn', description: '9 Mô hình máy + 9 Sản phẩm chức năng. Mô hình máy quyết định năng lực phần cứng; Sản phẩm chức năng quyết định bộ công cụ chuyên biệt. Giá pilot, cần xác minh chi phí trước thương mại.', eyebrow: 'Plans', heroTitle: '9 Mô hình máy + 9 Sản phẩm chức năng.', heroText: 'Hai dòng sản phẩm song song: Mô hình máy là cấp độ máy (tác nhân, bộ nhớ, kho dữ liệu, hạn mức). Sản phẩm chức năng là bộ công cụ chuyên biệt. Chọn 1 Mô hình máy + 1 hoặc nhiều Sản phẩm chức năng.', primaryCta: 'Khởi tạo Máy Tính AI Nguyễn', secondaryCta: 'Liên hệ tư vấn',
    sections: [
      { title: 'Hai dòng sản phẩm', body: 'Dòng 1 — 9 Mô hình máy: cấp độ Máy Tính AI từ cơ bản đến enterprise. Dòng 2 — 9 Sản phẩm chức năng: bộ công cụ chuyên biệt theo chức năng. Hai dòng độc lập nhưng phối hợp.' },
    ...
    pricingTable: {
      ...
      body: 'Giá hiện là giả thuyết pilot, cần xác minh chi phí AI, lưu trữ, hỗ trợ và pháp lý trước khi công bố thương mại.',
      plans: [
        { name: 'Nguyen Start', code: 'nguyen-start', price: 'Free', target: 'Người mới thử', features: ['2 Tác nhân (Guide, Guardian)', '100MB bộ nhớ, 500MB kho dữ liệu', '10 commands/ngày', 'Model tier: free', 'Không Siêu Ứng Dụng, không quy trình scheduling'], cta: 'Bắt đầu miễn phí' },
        { name: 'Nguyen Personal', code: 'nguyen-personal', price: '299.000₫', period: '/tháng', target: 'Cá nhân', features: ['4 Tác nhân (+Researcher, Verifier)', '5GB bộ nhớ, 10GB kho dữ liệu', '100 commands/ngày, 500K tokens', 'Siêu Ứng Dụng: AI Office, Research, Content', 'Model tier: standard'], cta: 'Chọn Personal' },
        { name: 'Nguyen Family', code: 'nguyen-family', price: '599.000₫', period: '/tháng', target: 'Gia đình 2-6 người', features: ['5 Tác nhân (+Family Steward)', '20GB bộ nhớ, 50GB kho dữ liệu', '300 commands/ngày, 1M tokens', 'Siêu Ứng Dụng: + Nguyen Roots, Memory', 'Family calendar, oral history, shared vault'], cta: 'Chọn Family' },
        { name: 'Nguyen Creator', code: 'nguyen-creator', price: '999.000₫', period: '/tháng', target: 'Người sáng tạo', features: ['5 Tác nhân (+Creator specialist)', '20GB bộ nhớ, 100GB kho dữ liệu', '500 commands/ngày, 2M tokens', 'Siêu Ứng Dụng: + AI Media, AI Browser', 'Bilingual publishing, SEO, multi-channel'], cta: 'Chọn Creator' },
        { name: 'Nguyen Founder', code: 'nguyen-founder', price: '1.999.000₫', period: '/tháng', target: 'Nhà sáng lập', features: ['7 Tác nhân (+Founder, Business Operator)', '50GB bộ nhớ, 200GB kho dữ liệu', '1.000 commands/ngày, 5M tokens', 'Siêu Ứng Dụng: + Founder OS, Finance, Legal', 'Decision log, pitch deck, KPI dashboard', 'Financial approval gate'], cta: 'Chọn Founder', highlighted: true },
        { name: 'Nguyen Business', code: 'nguyen-business', price: '4.999.000₫', period: '/tháng', target: 'Doanh nghiệp 5-25 seat', features: ['8 Tác nhân (+Global Connector)', '200GB bộ nhớ, 1TB kho dữ liệu', '5.000 commands/ngày, 20M tokens', 'Siêu Ứng Dụng: + Business OS, Sales, Automation, Code', 'Multi-seat, RBAC, CRM, SOP, audit'], cta: 'Chọn Business' },
        { name: 'Nguyen Chapter', code: 'nguyen-chapter', price: '7.999.000₫', period: '/tháng', target: 'Chi họ, hội, cộng đồng', features: ['9 Tác nhân (all)', '500GB bộ nhớ, 5TB kho dữ liệu', '10.000 commands/ngày, 50M tokens', 'Siêu Ứng Dụng: + Chapter OS, Network, Knowledge, Trust', 'Membership, governance, events, chapter website'], cta: 'Chọn Chapter' },
        { name: 'Nguyen Enterprise', code: 'nguyen-enterprise', price: 'Báo giá', target: 'Tổ chức lớn 25+ seat', features: ['9 Tác nhân + custom', 'Custom bộ nhớ, custom kho dữ liệu', 'Custom hạn mức', 'Model tier: enterprise + private routing', 'SSO, tenant isolation, SLA, audit export', 'Shared cloud, region selection'], cta: 'Liên hệ' },
        { name: 'Nguyen Sovereign', code: 'nguyen-sovereign', price: 'Báo giá', target: 'Dedicated/private deployment', features: ['9 Tác nhân + custom', 'Dedicated infrastructure', 'Unlimited hạn mức', 'Model tier: enterprise + private model', 'On-premise option, data residency', 'Custom security, incident response SLA'], cta: 'Liên hệ', highlighted: true }
      ]
    },
    planDetails: {
      ...
      plans: [
        { name: 'Nguyen Start', code: 'nguyen-start', price: 'Free', status: 'Available', target: 'Người mới thử nghiệm', members: '1 người', agents: '2 (Guide, Guardian)', superApps: 'Không', memory: '100MB', storage: '500MB kho dữ liệu', compute: '10 commands/ngày, 50K tokens', evidence: 'Audit log cơ bản', approval: 'Sensitive action gate', academy: 'Free track only', support: 'Community', limits: 'Không quy trình scheduling, không Siêu Ứng Dụng', overage: 'Hard cap, không overage', cta: 'Bắt đầu miễn phí' },
        { name: 'Nguyen Personal', code: 'nguyen-personal', price: '299.000₫', period: '/tháng', status: 'Beta', target: 'Cá nhân', members: '1 người', agents: '4 (+Researcher, Verifier)', superApps: '3 (AI Office, Research, Content)', memory: '5GB', storage: '10GB kho dữ liệu', compute: '100 commands/ngày, 500K tokens', evidence: 'Evidence pack, audit log', approval: 'Sensitive action gate', academy: 'Free track + paid Academy Pass', support: 'Email', limits: 'Không quy trình scheduling dài hạn', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Personal' },
        { name: 'Nguyen Family', code: 'nguyen-family', price: '599.000₫', period: '/tháng', status: 'Beta', target: 'Gia đình 2-6 người', members: '2-6 người', agents: '5 (+Family Steward)', superApps: '5 (+Nguyen Roots, Memory)', memory: '20GB', storage: '50GB kho dữ liệu', compute: '300 commands/ngày, 1M tokens', evidence: 'Evidence pack, family audit log', approval: 'Family approval gate', academy: 'Free track + Heritage track', support: 'Email + chat', limits: 'Shared kho dữ liệu theo thế hệ', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Family' },
        { name: 'Nguyen Creator', code: 'nguyen-creator', price: '999.000₫', period: '/tháng', status: 'Beta', target: 'Người sáng tạo', members: '1-3 người', agents: '5 (+Creator specialist)', superApps: '5 (+AI Media, AI Browser)', memory: '20GB', storage: '100GB kho dữ liệu', compute: '500 commands/ngày, 2M tokens', evidence: 'Evidence pack, audit log', approval: 'Sensitive action gate', academy: 'Free track + paid Academy Pass', support: 'Email + chat', limits: 'Editorial calendar, multi-channel', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Creator' },
        { name: 'Nguyen Founder', code: 'nguyen-founder', price: '1.999.000₫', period: '/tháng', status: 'Beta', target: 'Nhà sáng lập', members: '1-5 người', agents: '7 (+Founder, Business Operator)', superApps: '8 (+Founder OS, Finance, Legal)', memory: '50GB', storage: '200GB kho dữ liệu', compute: '1.000 commands/ngày, 5M tokens', evidence: 'Evidence pack, decision log, audit', approval: 'Financial approval gate', academy: 'Free track + Founder track', support: 'Email + chat + priority', limits: 'Decision log, KPI dashboard, pitch deck', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Founder', highlighted: true },
        { name: 'Nguyen Business', code: 'nguyen-business', price: '4.999.000₫', period: '/tháng', status: 'Planned', target: 'Doanh nghiệp 5-25 seat', members: '5-25 seat', agents: '8 (+Global Connector)', superApps: 'All (+Business OS, Sales, Automation, Code)', memory: '200GB', storage: '1TB kho dữ liệu', compute: '5.000 commands/ngày, 20M tokens', evidence: 'Evidence pack, audit trail, compliance export', approval: 'Per-role approval gate', academy: 'Free track + Business track', support: 'Email + chat + SLA', limits: 'Multi-seat, RBAC, CRM, SOP', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Business' },
        { name: 'Nguyen Chapter', code: 'nguyen-chapter', price: '7.999.000₫', period: '/tháng', status: 'Planned', target: 'Chi họ, hội, cộng đồng', members: '50-500 thành viên', agents: '9 (all)', superApps: 'All+ (+Chapter OS, Network, Knowledge, Trust)', memory: '500GB', storage: '5TB kho dữ liệu', compute: '10.000 commands/ngày, 50M tokens', evidence: 'Evidence pack, governance audit, compliance export', approval: 'Board approval gate', academy: 'Free track + Heritage track', support: 'Email + chat + SLA', limits: 'Membership, governance, events, chapter website', overage: 'Soft cap, cảnh báo khi 80%', cta: 'Chọn Chapter' },
