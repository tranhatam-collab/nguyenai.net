...
INSERT OR IGNORE INTO learning_paths (path_id, slug, title_vi, title_en, level, total_hours, status, created_at, updated_at)
...
-- Course: Cấp 0
INSERT OR IGNORE INTO courses (course_id, path_id, slug, title_vi, title_en, level, description_vi, description_en, status, created_at, updated_at)
...
-- Module 1: Nhập môn
INSERT OR IGNORE INTO modules (module_id, course_id, title_vi, title_en, sort_order, status, created_at, updated_at)
...
INSERT OR IGNORE INTO lessons (lesson_id, module_id, slug, title_vi, title_en, sort_order, duration_minutes, status, reading_content, assignment_desc, product_desc, created_at, updated_at)
...
-- Quiz cho Lesson 1
INSERT OR IGNORE INTO quizzes (quiz_id, title_vi, title_en, questions, pass_score, max_attempts, duration_minutes, status, created_at, updated_at)
...
INSERT OR IGNORE INTO assignments (assignment_id, lesson_id, title_vi, title_en, description_vi, description_en, expected_product, deadline_days, status, created_at, updated_at)
...
INSERT OR IGNORE INTO modules (module_id, course_id, title_vi, title_en, sort_order, status, created_at, updated_at) VALUES
...
INSERT OR IGNORE INTO lessons (lesson_id, module_id, slug, title_vi, title_en, sort_order, duration_minutes, status, reading_content, assignment_desc, product_desc, created_at, updated_at) VALUES
...
INSERT OR IGNORE INTO rubrics (rubric_id, title, levels, criteria, weightage, status, created_at, updated_at)
