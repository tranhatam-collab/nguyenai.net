...
**Nguyen AI = Brand layer + Vertical product configuration + Content/academy experience + Strategic distribution + Shared Gen 1 runtime + Shared Gen 2 product services**

Không nên là:
- một runtime mới
- một auth system mới
- một academy engine mới
- một billing engine mới
- một certificate engine mới
...
Backend phải đến từ: Identity Service, Gen 1 Command API, Gen 1 Job/Workflow API, Gen 1 Approval API, Gen 2 Entitlement API, Gen 2 Billing API.
