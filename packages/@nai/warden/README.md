...
Wrapper package for [openfga](https://github.com/openfga/openfga).
...
The original `openfga` is consumed via its native package manager, not via npm. This package exists to:
