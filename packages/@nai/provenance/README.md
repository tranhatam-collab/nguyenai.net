...
Wrapper package for [slsa](https://github.com/slsa-framework/slsa-github-generator).
...
- **Source clone**: `ai-dev-stack-repos/slsa/`

## Usage

The original `slsa` is consumed via its native package manager, not as
