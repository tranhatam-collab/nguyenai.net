...
Wrapper package for [llama_index](https://github.com/run-llama/llama_index).
...
The original `llama_index` is consumed via its native package manager, not via npm. This package exists to:
