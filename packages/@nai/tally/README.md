...
Wrapper package for [helicone](https://github.com/Helicone/helicone).
...
- **Source clone**: `ai-dev-stack-repos/helicone/`

## Usage

The original `helicone` is consumed via its native package manager, not as
