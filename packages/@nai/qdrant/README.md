...
Wrapper package for [qdrant](https://github.com/qdrant/qdrant).
...
The original `qdrant` is consumed via its native package manager, not via npm. This package exists to:
