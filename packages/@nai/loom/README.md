...
Wrapper package for [n8n](https://github.com/n8n-io/n8n).
...
- **Source clone**: `ai-dev-stack-repos/n8n/`

## Usage

The original `n8n` is consumed via its native package manager, not as
