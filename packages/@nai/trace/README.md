...
Wrapper package for [langfuse](https://github.com/langfuse/langfuse).
...
- **Source clone**: `ai-dev-stack-repos/langfuse/`

## Usage

The original `langfuse` is consumed via its native package manager, not as
