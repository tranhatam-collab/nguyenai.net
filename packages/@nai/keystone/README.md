...
Wrapper package for [better-auth](https://github.com/better-auth/better-auth).
...
- **Source clone**: `ai-dev-stack-repos/better-auth/`

## Usage

The original `better-auth` is consumed via its native package manager, not as
