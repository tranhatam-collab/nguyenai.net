...
Wrapper package for [deepeval](https://github.com/confident-ai/deepeval).
...
The original `deepeval` is consumed via its native package manager, not via npm. This package exists to:
