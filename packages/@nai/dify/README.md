...
Wrapper package for [dify](https://github.com/langgenius/dify).
...
- **Source clone**: `ai-dev-stack-repos/dify/`

## Usage

The original `dify` is consumed via its native package manager, not as
