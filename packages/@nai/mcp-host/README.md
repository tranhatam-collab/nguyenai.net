...
Wrapper package for [servers](https://github.com/modelcontextprotocol/servers).
...
- **Source clone**: `ai-dev-stack-repos/servers/`

## Usage

The original `servers` is consumed via its native package manager, not as
