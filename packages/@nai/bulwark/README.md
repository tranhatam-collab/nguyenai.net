...
Wrapper package for [trivy](https://github.com/aquasecurity/trivy).
...
The original `trivy` is consumed via its native package manager, not via npm. This package exists to:
