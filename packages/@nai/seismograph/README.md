...
Wrapper package for [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector).
...
The original `opentelemetry-collector` is consumed via its native package manager, not via npm. This package exists to:
