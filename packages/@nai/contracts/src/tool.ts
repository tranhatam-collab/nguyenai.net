...
export const BUILT_IN_FREE_APIS: FreeApiRegistry[] = [
  ...
  {
    id: "openai-image",
    name: "OpenAI Image Gen (BYOK)",
    url: "https://api.openai.com/v1/images/generations",
    category: "image",
    description: "Image generation via DALL-E (requires OpenAI API key)",
    authType: "api-key",
    docsUrl: "https://platform.openai.com/docs/guides/images",
    rateLimit: "by key tier",
  ...
  {
    id: "openai-whisper",
    name: "OpenAI Whisper (BYOK)",
    url: "https://api.openai.com/v1/audio/transcriptions",
    category: "audio",
    description: "Speech-to-text transcription via Whisper (requires OpenAI key)",
    authType: "api-key",
  ...
  },
  {
    ...
    category: "audio",
    description: "Synthesize speech from text (requires Google Cloud key)",
    authType: "api-key",
    docsUrl: "https://cloud.google.com/text-to-speech/docs",
    rateLimit: "1M chars/month (free tier)",
