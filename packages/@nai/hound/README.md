...
Wrapper package for [grype](https://github.com/anchore/grype).
...
The original `grype` is consumed via its native package manager, not via npm. This package exists to:
