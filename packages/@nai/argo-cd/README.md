...
Wrapper package for [argo-cd](https://github.com/argoproj/argo-cd).
...
The original `argo-cd` is consumed via its native package manager, not via npm. This package exists to:
