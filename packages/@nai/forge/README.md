...
Wrapper package for [promptfoo](https://github.com/promptfoo/promptfoo).
...
- **Source clone**: `ai-dev-stack-repos/promptfoo/`

## Usage

The original `promptfoo` is consumed via its native package manager, not as
