...
Wrapper package for [openhands](https://github.com/All-Hands-AI/OpenHands).
...
The original `openhands` is consumed via its native package manager, not via npm. This package exists to:
