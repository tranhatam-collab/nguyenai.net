...
Wrapper package for [gitleaks](https://github.com/gitleaks/gitleaks).
...
The original `gitleaks` is consumed via its native package manager, not via npm. This package exists to:
