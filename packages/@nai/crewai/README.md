...
Wrapper package for [crewAI](https://github.com/crewAIInc/crewAI).
...
The original `crewAI` is consumed via its native package manager, not via npm. This package exists to:
