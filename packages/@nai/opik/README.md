...
Wrapper package for [opik](https://github.com/comet-ml/opik).
...
The original `opik` is consumed via its native package manager, not via npm. This package exists to:
