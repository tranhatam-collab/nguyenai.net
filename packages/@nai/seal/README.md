...
Wrapper package for [cosign](https://github.com/sigstore/cosign).
...
The original `cosign` is consumed via its native package manager, not via npm. This package exists to:
